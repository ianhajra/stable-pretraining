#!/usr/bin/env bash
# run_supervised.sh — Submit supervised baseline training jobs for all dataset/encoding combos.
#
# Usage:
#   bash scripts/train/run_supervised.sh [--script PATH]
#
...
TRAIN_SCRIPT="$SCRIPT_DIR/supervised.py"
...
header "FF × heatmap"
submit_job \
    "sup_heatmap_ff_w$(printf '%03d' $WINDOW_SIZE_FF)" \
...
echo "  Logs           : logs/sup_*_%j.out / .err"
echo "================================================================"
