#!/usr/bin/env bash
# run_lejepa.sh — Submit LeJEPA training jobs for all dataset/encoding combos.
#
# Usage:
#   bash scripts/train/run_lejepa.sh [--script PATH]
#
...
TRAIN_SCRIPT="$SCRIPT_DIR/lejepa.py"
...
submit_job \
    "lejepa_gaf_sp500_w$(printf '%03d' $WINDOW_SIZE_GAF)" \
...
submit_job \
    "lejepa_candle_sp500_w$(printf '%03d' $WINDOW_SIZE_CANDLE)" \
...
echo "  Logs           : logs/lejepa_*_%j.out / .err"
echo "================================================================"
